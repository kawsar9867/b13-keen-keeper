...
import logo3 from "/Assets/video.png";
...
const CardDetails = () => {
  ...
  const handleCall = () => {
    setCard([...card, { ...user, type: "Call" }]);
  };
  const handleText = () => {
    setCard([...card, { ...user, type: "Text" }]);
  };
  const handleVideo = () => {
    setCard([...card, { ...user, type: "Video" }]);
  };
  return (
    <div>
          ...
          <div className="col-span-12 md:col-span-4 space-y-4">
            <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm text-center flex flex-col items-center">
              <img
                src={profile_pic}
                alt="Emma"
                className=" w-20 h-20 rounded-full  mb-2 border-2 border-green-200 ring-1 ring-gray-300"
              />
              ...
              <div className=" space-y-2">
                ...
                <span className="block text-[10px] font-bold px-3 py-0.5 rounded-full uppercase tracking-wider flex gap-1">
                  {tag.map((t, i) => (
                    <span
                      key={i}
              ...
              <p className="mt-1 text-xs text-gray-400 font-semibold italic">
                {email}
              </p>
            </div>
          ...
          <div className="col-span-12 md:col-span-8 space-y-5">
            <div className="grid grid-cols-3 gap-4">
              <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm text-center">
                ...
                <div className="text-[11px] text-green-700 mt-1 uppercase font-semibold">
                  Days Since Contact
                </div>
              </div>
              <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm text-center">
                <div className="text-3xl font-bold text-green-600">{goal}</div>
                <div className="text-[11px] text-green-700 mt-1 uppercase font-semibold">
                  Goal (Days)
                </div>
              </div>
              <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm text-center">
                <div className="text-xl font-bold text-green-600 mt-1.5">
                  {next_due_date}
                </div>
                <div className="text-[11px] text-green-700 mt-1 uppercase font-semibold">
                  Next Due
            ...
            <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm relative">
              <button className="absolute top-4 right-4 bg-gray-50 text-gray-500 px-3 py-1 rounded text-xs font-bold border border-gray-300   cursor-pointer hover:bg-green-600 hover:text-white">
                edit
              </button>
              ...
              <p className="text-green-600 font-semibold text-sm">
                Connect every{" "}
                <span className="font-bold text-green-500">{goal} days</span>
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
              ...
              <div className="grid grid-cols-3 gap-3">
                <button
                  onClick={() => handleCall()}
                  className=" flex flex-col items-center justify-center p-4 border border-gray-100 hover:border-green-500 rounded-lg hover:bg-green-200 transition bg-gray-50/50 cursor-pointer"
                >
                ...
                <button
                  onClick={() => handleText()}
                  className="flex flex-col items-center justify-center p-4 border border-gray-100 rounded-lg bg-gray-50/50 hover:bg-gray-400 hover:text-white transition cursor-pointer"
                >
                ...
                <button
                  onClick={() => handleVideo()}
                  className="flex flex-col items-center justify-center p-4 border border-gray-100 hover:border-green-500 rounded-lg bg-gray-50/50 hover:bg-green-200 hover:text-gray-500 transition cursor-pointer"
                >
